...
namespace Enemies.Sludge
{
    ...
    public class SludgeBehavior : MonoBehaviour {
        ...
        [Header("Gravity")]
        [SerializeField, Tooltip("The base gravity applied to the enemy.")]
        ...
        private void Start() {
            ...
            _emitter = AudioManager.Instance.InitializeEventEmitter(FMODEvents.instance.sludgeMove, gameObject);
        }
        ...
        /// <summary>
        /// Updates the sound effects based on the sludge's movement state.
        /// </summary>
        private void UpdateSound() {

            // Start move event if the sludge moves and is on the ground
